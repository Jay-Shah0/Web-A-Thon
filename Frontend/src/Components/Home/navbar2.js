...
const Navbar2 = () => {
  ...
  return (
    <>
        ...
        <ul className="lists">
           <li className='list'><Link to="/Templets">Templets</Link></li>
          <li className='list'><Link to="/Tshirt">T-shirts</Link></li>
          <li className='list'><Link to="/UseAI">Use AI</Link></li>
        </ul>
        ...
        <ul className='sign_lists'>
          <li className='sign_list'> 
            <Link to="http://localhost:5173/">
              <button className="sign" id='sign_in' onClick={() => setShowSignupPopup(!showSignupPopup)}>
                <span className='sign_text'>+ Create</span>
              </button>
            </Link>
          </li>
          ...
          <li className='sign_list' >
            <Link to="http://localhost:5173/">
              <button className="signup" id='sign_up'>
                <span className='sign_text'>My Project</span>
              </button>
            </Link>
          </li>
        </ul>
